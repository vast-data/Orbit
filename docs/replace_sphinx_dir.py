...
search_directory = ".."  # repo root (docs/ + the vastorbit package)
search_word = "SPHINX_DIRECTORY"
replacement_word = DOCS_DIR

# Never rewrite the substitution scripts themselves.
...
print(f"Replacing '{search_word}' -> '{replacement_word}'")
