...
.. ipython:: python
    ...
    data = vo.VastFrame({"x": np.concatenate([x, x + k]), "y": np.concatenate([y, y + k]), "z": np.concatenate([z, z + k]), "c": [0 for i in range(round(N / 2))] + [1 for i in range(round(N / 2))]})
    ...
    .. tab:: Forward
      ...
      **Stepwise**
      ...
      .. ipython:: python
          ...
          @savefig plotting_matplotlib_stepwise_forward_stepwise_0.png
          figs.step_wise_
      ...
      **Feature Importance**
      ...
      .. ipython:: python
          ...
          @savefig plotting_matplotlib_stepwise_backward_importance.png
          figs.importance_
    ...
    .. tab:: Backward
      ...
      **Stepwise**
      ...
      .. ipython:: python
          ...
          @savefig plotting_matplotlib_stepwise_forward_stepwise_1.png
          figs.step_wise_
...
.. hint:: vastorbit supports both backward and forward stepwise analysis. You simply need to select the appropriate method as a parameter.
...
.. note:: As stepwise plots are essentially scatter and bubble plots, customization options are identical to those available for :ref:`chart_gallery.scatter`.
