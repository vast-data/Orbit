...
.. hint:: In vastorbit, you have a range of options for customizing your range plots. You can select custom quantiles for both the lower and upper bounds, allowing you to precisely define the range of data displayed in your range plot.
