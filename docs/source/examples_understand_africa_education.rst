...
Eight seems to be a suitable number of clusters. Let's compute a :py:mod:`~vastorbit.machine_learning.vast.cluster.KMeans` model.
...
.. code-block:: python
    ...
    # Adding the prediction to the VastFrame
...
We can add these predictions to the main :py:mod:`~vastorbit.VastFrame`.
