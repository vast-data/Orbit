...
VAST Pipelines is an open source platform for managing data
...
* Have access to a machine that has VAST installed
...
The information in connection.yaml will be the same you use in vastorbit.
...
.. code:: bash
    ...
    python -m vastorbit.pipeline.parser [connection_file] [input_file] -o [output file]

Both of the following will generate a sql file: **gettingStarted.sql**

.. code:: bash

   python -m vastorbit.pipeline.parser connection.yaml gettingStarted.yaml

.. code:: bash

   python -m vastorbit.pipeline.parser connection.yaml gettingStarted.yaml -o gettingStarted.sql
...
For more information on how to customize this step: `DataLoader Parameters <https://docs.VAST.com/latest/en/sql-reference/statements/create-statements/create-data-loader/#arguments>`_  and `Copy Parameters <https://docs.VAST.com/latest/en/sql-reference/statements/copy/>`_ .
...
For more information on how to customize this step: :ref:`api.vastframe.features_engineering`.
...
For more information on how to customize this step: :ref:`api.machine_learning.vast`. 
...
For more information to on how to customize this step: `Cron Wiki <https://en.wikipedia.org/wiki/Cron>`_  and `VAST Schedulers <https://docs.VAST.com/latest/en/sql-reference/statements/create-statements/create-schedule/>`_ .
