...
To find all the duplicates, you can use the :py:func:`~vastorbit.VastFrame.duplicated` method.
...
That said, if we did want to drop these duplicates, we can do so with the :py:func:`~vastorbit.VastFrame.drop_duplicates` method.
