...
'Pythonic' Invokation of VAST Functions
-------------------------------------------

You can easily apply VAST functions to your :py:mod:`~vastorbit.VastFrame`. Here, we use VAST's ``COALESCE`` function to impute the ``age`` of the passengers in our dataset.
...
Slicing the VastFrame
-----------------------

You can now slice the :py:mod:`~vastorbit.VastFrame` with indexing operators.
