...
vastorbit offers several models, including a multiple time series model. For this example, let's use a :py:mod:`~vastorbit.machine_learning.vast.ARIMA` model.
...
Just like with other regression models, we'll evaluate our model with the :py:func:`~vastorbit.machine_learning.vast.ARIMA.report` method.
