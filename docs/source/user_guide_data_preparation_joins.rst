...
.. code-block:: python
    ...
    flights  = vo.read_csv("flights.csv")
    flights.head(100)
...
.. code-block:: python
    ...
    airports = vo.read_csv("airports.csv")
    airports.head(100)
...
.. code-block:: python
    ...
    airlines = vo.read_csv("airlines.csv")
    airlines.head(100)
...
.. ipython:: python
    ...
    import vastorbit as vo
    airlines = vo.read_csv("SPHINX_DIRECTORY/source/_static/website/examples/data/flights/airlines.csv")
...
To join datasets in vastorbit, use the :py:func:`~vastorbit.VastFrame.join` method.

.. ipython:: python

    help(vo.VastFrame.join)
