...
Let's use the `Telco Churn dataset <https://github.com/vast-data/Orbit/blob/main/assets/data/business/churn/customers.csv>`__ to understand how we can find links between different variables in vastorbit.
