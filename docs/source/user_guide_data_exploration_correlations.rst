...
Let's use the `Telco Churn dataset <https://raw.githubusercontent.com/vast-data/Orbit/main/assets/data/business/churn/customers.csv>`__ to understand how we can find links between different variables in vastorbit.
