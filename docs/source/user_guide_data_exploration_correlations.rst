...
Let's use the `Telco Churn dataset <https://github.com/vastdata-dev/vastorbit/blob/master/examples/business/churn/customers.csv>`_ to understand how we can find links between different variables in vastorbit.
