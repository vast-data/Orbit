...
:py:mod:`~vastorbit.machine_learning.vast.linear_model.LogisticRegression` is a very powerful algorithm and we can use it to detect churns. Let's split our :py:mod:`~vastorbit.VastFrame` into training and testing set to evaluate our model.
