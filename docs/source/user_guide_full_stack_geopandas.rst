...
The :py:func:`~vastorbit.VastFrame.apply` function of the vastorbit stats module allows you to apply any VAST function to the data. Let's compute the area of each country.
...
You can also draw maps using the :py:func:`~vastorbit.VastFrame.geo_plot` method.
