...
Let's create a VastFrame of the dataset. The dataset is available `here <https://github.com/vast-data/VAST-Orbit/blob/main/assets/data/business/spam/spam.csv>`__.
...
Let's add the most occurent words in our :py:mod:`~vastorbit.VastFrame` and compute the correlation vector.
