...
.. code-block:: python
    ...
    from vastorbit.core.tablesample import TableSample
...
.. code-block:: python
    ...
    commodities["elapsed_days"] = "EXTRACT(DAY FROM {})"
...
We can see strong correlations between most of the variables. A vector autoregression (:py:mod:`~vastorbit.machine_learning.vast.tsa.arima.VAR`) model seems ideal.

Machine Learning
-----------------

Let's create the :py:mod:`~vastorbit.machine_learning.vast.tsa.arima.VAR` model to predict the value of various commodities.

.. code-block:: python

    from vastorbit.machine_learning.vast import VAR
