...
To build a customized feature, you can use the :py:func:`~vastorbit.VastFrame.eval` method of the :py:mod:`~vastorbit.VastFrame`. Let's look at an example with the well-known ``titanic`` dataset.
...
When using the :py:func:`~vastorbit.VastFrame.eval` method, you can enter any SQL expression and vastorbit will evaluate it!

Regular Expressions
--------------------

To compute features using regular expressions, we'll use the :py:func:`~vastorbit.VastFrame.regexp` method.
...
The :py:func:`~vastorbit.VastFrame.analytic` method contains the many advanced analytical functions in vastorbit.
...
Moving windows are powerful features. Moving windows are managed by the :py:func:`~vastorbit.VastFrame.rolling` method in vastorbit.
