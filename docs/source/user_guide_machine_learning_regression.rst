...
Let's predict the total charges of the Telco customers using their tenure. We will start by importing `the telco dataset <https://raw.githubusercontent.com/vast-data/Orbit/main/assets/data/business/churn/customers.csv>`__.
