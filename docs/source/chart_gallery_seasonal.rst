...
.. ipython:: python
    ...
    import vastorbit.machine_learning.model_selection.statistical_tests as vmlt

    passengers = vod.load_airline_passengers()
...
But before that let's import the vastorbit statistical tests and decompose the time series.
