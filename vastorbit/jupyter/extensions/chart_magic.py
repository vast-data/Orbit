...
from vastorbit._utils._sql._format import clean_query, replace_vars_in_query
...
def chartSQL(
    ...
    if kind in [
        ...
        vdf = VastFrame(input_relation=query)
    ...
    vo_plt, kwargs = PlottingUtils().get_plotting_lib(class_name=class_name)
    graph = getattr(vo_plt, class_name)
...
def chart_magic(line: str, cell: Optional[str] = None, local_ns: Optional[dict] = None):
        ...
        Chart Type, one  of  the following:
         ...
         - kendall:
            ...
            .. Warning::
                ...
                count of  the :py:class:`~VastFrame`.
         - line:
            Line Plot.
         - negative_bar:
    ...
    * Using SQL files
    ...
    .. note::
        ...
        In this example, we use a :py:class:`~VastFrame`, but it's
