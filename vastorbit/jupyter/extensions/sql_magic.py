...
from vastorbit._utils._parsers import parse_explain_graphviz
...
def sql_magic(
    ...
    **Execution**: 0.005s
    ...
    :py:class:`~VastFrame`, which is assigned to
    ...
    **Execution**: 0.007s
    ...
    :py:class:`~VastFrame`, allowing
    you to call :py:class:`~VastFrame`
    methods:
    ...
    variable can be a :py:class:`~VastFrame`,
    a :py:class:`~vastorbit.core.tablesample.base.TableSample`, a ``pandas.DataFrame``,
    ...
    **Execution**: 0.014s
    ...
    .. note::
        ...
        vastorbit will store the object in a temporary
    ...
    **Execution**: 0.006s
    ...
    try:
        ...
        for i in range(n):
            ...
            if (query_type == "COPY") and ("from local" in query.lower()):
                ...
                or (
                    ...
                    and (
                        query_type.lower()
                        not in ("profile", "select", "show", "with", "undefined")
                    )
                )
        ...
        if (
            ...
            and (result.object_type == "VastFrame")
            and ("-o" in options)
        ):
            if options["-o"][-4:] == "json":
