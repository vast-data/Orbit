...
def get_header_names(
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._parsers import get_header_names

        # Creating a CSV example.
        file_name = 'vastorbit_test_parsers.csv'
        f = open(file_name, 'a')
...
def get_first_record_as_list(path: str, sep: str, record_terminator: str) -> List[str]:
    ...
    .. code-block:: python
        ...
        # import the function
        from vastorbit._utils._parsers import get_first_record_as_list
...
def read_first_record(path: str, record_terminator: str) -> str:
    ...
    .. code-block:: python
        ...
        # import the function
        from vastorbit._utils._parsers import read_first_record
