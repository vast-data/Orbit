...
def erase_prefix_in_name(name: str, prefix: Optional[list] = None) -> str:
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._sql._merge import erase_prefix_in_name
...
def erase_suffix_in_name(name: str, suffix: Optional[list] = None) -> str:
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._sql._merge import erase_suffix_in_name
...
def erase_word_in_name(name: str, word: Optional[list] = None) -> str:
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._sql._merge import erase_word_in_name
...
def erase_in_name(
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._sql._merge import erase_in_name
...
def is_similar_name(
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._sql._merge import is_similar_name
...
def belong_to_group(
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._sql._merge import belong_to_group
...
def group_similar_names(
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._sql._merge import group_similar_names
