...
from vastorbit._utils._sql._format import clean_query, quote_ident
...
def get_dblink_fun(query: str, symbol: str = "$") -> str:
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit._utils._sql._dblink import get_dblink_fun
    ...
    for s in external_connections:
        ...
        for external_query in external_queries:
            ...
            if " " in external_query.strip():
                alias = f"VASTORBIT_EXTERNAL_TABLE_{nb_external_queries}"
            else:
