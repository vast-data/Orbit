...
from vastorbit._config.validators import (
    bool_validator,
    in_validator,
...
from vastorbit.errors import OptionError
...
def get_import_success(module: str) -> bool:
    ...
    .. ipython:: python
        ...
        from vastorbit._config.config import get_import_success

        # Checking an existing module
        get_import_success('vastorbit')
    ...
    .. note::
        ...
        modules are installed to enhance vastorbit
        capabilities.
    """
...
class Option:
    ...
    .. ipython:: python
        ...
        from vastorbit._config.validators import in_validator

        # Importing the Option class
        from vastorbit._config.config import Option
    ...
    .. seealso::
        ...
        | :py:meth:`~vastorbit.register_option` :
            Registers the input option.
        | :py:meth:`~vastorbit.set_option` :
            Sets vastorbit options.
    """
...
def get_option(key: str) -> Any:
    ...
    .. ipython:: python
        ...
        # Importing the function
        from vastorbit._config.config import get_option
...
def register_option(op: Option) -> None:
    ...
    .. ipython:: python
        ...
        # Importing the function
        from vastorbit._config.config import register_option
...
def set_option(key: str, value: Any = None) -> None:
    ...
    .. important::
        ...
        Some options may not be available in vastorbit
        1.0.0. To access all available options, please
        use vastorbit 1.0.1 or a higher version.
    ...
    key: str
        ...
        - cache:
            [bool]
            If set to True, VastFrames save the
        ...
        - count_on:
            ...
            :py:class:`~VastFrame` and :py:class:`~vastorbit.core.tablesample.base.TableSample`
            is computed and displayed in the footer (if
            ``footer_on is True``).
        - footer_on:
            [bool]
            If set to ``True``, :py:class:`~VastFrame` and
            :py:class:`~vastorbit.core.tablesample.base.TableSample` show a footer that includes
            information about the displayed rows and columns.
        - interactive:
            [bool]
            If set to ``True``, vastorbit outputs are
        ...
        - max_rows:
            ...
            not changed.
        - max_cellwidth:
            Maximum width of any vastorbit table's cell.
            Can not be lesser than 280.
            Default: 280
        - max_tableheight:
            Maximum height of vastorbit tables.
            Can not be lesser than 300.
            Default: 300
        - mode:
            [str]
            Display mode for vastorbit outputs, either:

            **full**:
                vastorbit regular display mode.
        ...
        - print_info:
            ...
            time the :py:class:`~VastFrame` is modified.
        - random_state:
            [int]
        ...
        - save_query_profile:
            ...
            to differentiate the vastorbit logs from the
            VAST logs. If set to ``False``, this functionality
            is deactivated.
        - sql_on:
            [bool]
    ...
    .. hint::
        ...
        vastorbit provides multiple datasets, all of
    ...
    Customize VastFrame Display Settings
    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    .. warning::
        ...
        vastorbit will perform calculations to determine
        the number of elements in a displayed :py:class:`~VastFrame`,
    ...
    .. hint::
        ...
        display of :py:class:`~VastFrame`, creating
    ...
    .. note::
        ...
        VAST sometimes caches the SQL query,
    ...
    **Computing the different aggregations**.
    ...
    SELECT /*+LABEL('VastFrame.aggregate')*/ MAX("age") FROM "default"."titanic" LIMIT 1
    ...
    **Execution**: 0.072s
    ...
    .. ipython:: python
        ...
        set_option("temp_schema", "default")
...
# SQL
# Temp Schema
register_option(Option("temp_schema", "default", "", str_validator))
# Query & Time
