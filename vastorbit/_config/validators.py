...
def bool_validator(val: bool) -> Literal[True]:
    ...
    .. ipython:: python
        ...
        from vastorbit._config.validators import bool_validator
    ...
    .. seealso::
        ...
        | :py:meth:`~vastorbit.set_option` : Sets vastorbit options.
    """
...
def optional_bool_validator(val: Optional[bool]) -> Literal[True]:
    ...
    .. ipython:: python
        ...
        # Importing the function.
        from vastorbit._config.validators import optional_bool_validator
...
def optional_positive_int_validator(val: Optional[int]) -> Literal[True]:
    ...
    .. ipython:: python
        ...
        # Importing the function.
        from vastorbit._config.validators import optional_positive_int_validator
...
def optional_str_validator(val: Optional[str]) -> Literal[True]:
    ...
    .. ipython:: python
        ...
        # Importing the function.
        from vastorbit._config.validators import optional_str_validator
...
def str_validator(val: str) -> Literal[True]:
    ...
    .. ipython:: python
        ...
        # Importing the function.
        from vastorbit._config.validators import str_validator
...
def st_positive_int_validator(val: int) -> Literal[True]:
    ...
    .. ipython:: python
        ...
        # Importing the function.
        from vastorbit._config.validators import st_positive_int_validator
