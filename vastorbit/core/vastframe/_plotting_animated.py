...
from vastorbit.core.vastframe._plotting import vDFPlot
...
class vDFAnimatedPlot(vDFPlot):
    ...
    def animated_bar(
        ...
        **style_kwargs,
        ...
        by: str, optional
            Categorical VastColumn used in the partition.
        ...
        date_in_title: bool, optional
            If  set to True, the ts VastColumn is displayed in
            the title section.
        date_f: function, optional
            Function used to display the ts VastColumn.
        date_style_dict: dict, optional
            Style Dictionary used to display the ts VastColumn when
            date_in_title = False.
        ...
        .. ipython:: python
          ...
          with open("SPHINX_DIRECTORY/figures/code_VastFrame_plotting_animated_bar.html", "w") as file:
            file.write(fig.__html__())

        .. raw:: html
            :file: SPHINX_DIRECTORY/figures/code_VastFrame_plotting_animated_bar.html

        .. seealso::

            | ``VastFrame.``:py:meth:`~vastorbit.VastFrame.animated_pie` : Animated Pie Chart.
        ...
        if by:
            cols += [by]
        return vo_plt.AnimatedBarChart(
            vdf=self,
            order_by=ts,
            columns=cols,
    ...
    def animated_pie(
        ...
        **style_kwargs,
        ...
        .. ipython:: python
          ...
          with open("SPHINX_DIRECTORY/figures/code_VastFrame_plotting_animated_pie.html", "w") as file:
            file.write(fig.__html__())

        .. raw:: html
            :file: SPHINX_DIRECTORY/figures/code_VastFrame_plotting_animated_pie.html

        .. seealso::

            | ``VastFrame.``:py:meth:`~vastorbit.VastFrame.animated_bar` : Animated Bar Chart.
        ...
        if by:
            cols += [by]
        return vo_plt.AnimatedPieChart(
            vdf=self,
            order_by=ts,
            columns=cols,
            order_by_start=start_date,
    ...
    def animated_plot(
        ...
        **style_kwargs,
        ...
        .. ipython:: python
          ...
          with open("SPHINX_DIRECTORY/figures/code_VastFrame_plotting_animated_plot.html", "w") as file:
            file.write(fig.__html__())

        .. raw:: html
            :file: SPHINX_DIRECTORY/figures/code_VastFrame_plotting_animated_plot.html
        ...
        return vo_plt.AnimatedLinePlot(
            vdf=vdf,
            order_by=ts,
            columns=columns,
            order_by_start=start_date,
    ...
    def animated_scatter(
        ...
        **style_kwargs,
        ...
        fixed_xy_lim: bool, optional
            If  set to True, the xlim  and ylim are fixed.
        date_in_title: bool, optional
            If  set  to  True,  the  ts  VastColumn  is
            displayed in the title section.
        date_f: function, optional
            Function  used  to  display  the  ts  VastColumn.
        date_style_dict: dict, optional
            Style   Dictionary   used   to   display  the  ts
            VastColumn when date_in_title = False.
        interval: int, optional
            Number of ms between each update.
        repeat: bool, optional
            If  set to True, the animation is repeated.
        ...
        .. ipython:: python
          ...
          with open("SPHINX_DIRECTORY/figures/code_VastFrame_plotting_animated_scatter.html", "w") as file:
            file.write(fig.__html__())

        .. raw:: html
            :file: SPHINX_DIRECTORY/figures/code_VastFrame_plotting_animated_scatter.html
        ...
        return vo_plt.AnimatedBubblePlot(
            vdf=self,
            order_by=ts,
            columns=columns,
            catcol=catcol,
