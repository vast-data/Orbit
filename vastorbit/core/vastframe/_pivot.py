...
class vDFPivot(vDFJoinUnionSort):
    ...
    def explode_array(
        ...
        """
        Returns exploded VastFrame of array-like
        columns in a VastFrame.
        ...
        We can compute the exploded VastFrame.
        ...
        .. ipython:: python
            ...
            html_file = open("SPHINX_DIRECTORY/figures/core_VastFrame_vDFPivot_explode_array_table.html", "w")
            html_file.write(result._repr_html_())
            html_file.close()

        .. raw:: html
            :file: SPHINX_DIRECTORY/figures/core_VastFrame_vDFPivot_explode_array_table.html
        ...
        # Create a new VastFrame with exploded values
        vdf = create_new_vdf(f"""
            SELECT 
                /*+LABEL('VastFrame.explode')*/ 
                {index}, 
                {column}, 
                EXPLODE({column} 
