...
from vastorbit._utils._sql._format import format_magic, format_type


class StringSQL:
    """
    This class is utilized to represent SQL strings, with
    :py:class:`~VastColumn`, for instance, inheriting from
    ...
    init_transf: str, optional
        ...
        certain operations on :py:class:`~VastColumn`.
    ...
    :mod:`vastorbit.sql.functions` module. In this
    ...
    .. note::
        ...
        construct vastorbit code, as they adapt
    ...
    :py:class:`~VastColumn` inherit from
    :py:class:`~StringSQL`, enabling operations
    on :py:class:`~VastFrame` in a pandas-like
    manner.
