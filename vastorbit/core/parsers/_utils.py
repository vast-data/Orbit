...
def extract_col_dt_from_query(query: str, field: str) -> tuple:
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit.core.parsers._utils import extract_col_dt_from_query
...
def extract_compression(
    ...
    .. ipython:: python
        ...
        # Import the function.
        from vastorbit.core.parsers._utils import extract_compression
...
def get_first_file(path: str, ext: str) -> str:
    ...
    .. code-block:: python
        ...
        # Import the function.
        from vastorbit.core.parsers._utils import get_first_file
