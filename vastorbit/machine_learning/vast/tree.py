...
class DecisionTreeRegressor(RandomForestRegressor):
    ...
    .. ipython:: python
        ...
        from vastorbit.machine_learning.vast import DecisionTreeRegressor
    ...
    .. ipython:: python
        ...
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreereg_feature.html")
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreereg_feature.html
    ...
    .. ipython:: python
        ...
        result = model.report()
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreereg_report.html", "w")
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreereg_report.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreereg_prediction.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreereg_prediction.html
    ...
    .. ipython:: python
        ...
        res = model.plot_tree()
        res.render(filename='figures/machine_learning_VAST_tree_decision', format='png')


    .. image:: /../figures/machine_learning_VAST_tree_decision.png
    ...
    **To Python**
    ...
    .. hint::
        ...
        The
        :py:meth:`~vastorbit.machine_learning.vast.tree.DecisionTreeRegressor.to_python`
...
class DummyTreeRegressor(RandomForestRegressor):
    ...
    .. ipython:: python
        ...
        from vastorbit.machine_learning.vast import DummyTreeRegressor
    ...
    .. ipython:: python
        ...
        vo.set_option("plotting_lib", "plotly")
        fig = model.features_importance()
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreereg_feature.html")
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreereg_feature.html
    ...
    .. ipython:: python
        ...
        result = model.report()
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreereg_report.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreereg_report.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreereg_prediction.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreereg_prediction.html
    ...
    .. ipython:: python
        ...
        res = model.plot_tree()
        res.render(filename='figures/machine_learning_VAST_tree_dummy', format='png')


    .. image:: /../figures/machine_learning_VAST_tree_dummy.png
    ...
    **To Python**
    ...
    .. hint::
        ...
        The
        :py:meth:`~vastorbit.machine_learning.vast.tree.DummyTreeRegressor.to_python`
        method is used to retrieve predictions,
        probabilities, or cluster distances. For
        specific details on how to use this method
        for different model types, refer to the
...
class DecisionTreeClassifier(RandomForestClassifier):
    ...
    .. code-block::
        ...
        from vastorbit.machine_learning.vast import DecisionTreeClassifier
    ...
    .. ipython:: python
        ...
        vo.set_option("plotting_lib", "plotly")
        fig = model.features_importance()
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_feature.html")
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_feature.html
    ...
    .. ipython:: python
        ...
        result = model.report()
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_report.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_report.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_report_cutoff.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_report_cutoff.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_prediction.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_prediction.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_proba.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_proba.html
    ...
    .. ipython:: python
        ...
        fig = model.roc_curve()
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_roc.html")

    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dtreeclass_roc.html
    ...
    .. ipython:: python
        ...
        res = model.plot_tree()
        res.render(filename='figures/machine_learning_VAST_tree_decision_classifier', format='png')


    .. image:: /../figures/machine_learning_VAST_tree_decision_classifier.png
    ...
    **To Python**
    ...
    .. hint::
        ...
        The
        :py:meth:`~vastorbit.machine_learning.vast.tree.DecisionTreeClassifier.to_python`
        method is used to retrieve predictions,
        probabilities, or cluster distances. For
        specific details on how to use this method
        for different model types, refer to the
...
class DummyTreeClassifier(RandomForestClassifier):
    ...
    .. code-block::
        ...
        from vastorbit.machine_learning.vast import DummyTreeClassifier
    ...
    .. ipython:: python
        ...
        vo.set_option("plotting_lib", "plotly")
        fig = model.features_importance()
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_feature.html")
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_feature.html
    ...
    .. ipython:: python
        ...
        result = model.report()
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_report.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_report.html
    ...
    .. ipython:: python
        ...
        result = model.report(cutoff = 0.2)
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_report_cutoff.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_report_cutoff.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_prediction.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_prediction.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_proba.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_proba.html
    ...
    .. ipython:: python
        ...
        fig = model.roc_curve()
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_roc.html")

    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_dummytreecl_roc.html
    ...
    **To Python**
    ...
    .. hint::
        ...
        The
        :py:meth:`~vastorbit.machine_learning.vast.tree.DummyTreeClassifier.to_python`
        method is used to retrieve predictions,
        probabilities, or cluster distances. For
        specific details on how to use this method
        for different model types, refer to the
