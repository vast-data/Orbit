...
from vastorbit.machine_learning.vast.base import BinaryClassifier, Regressor
...
class LinearSVR(LinearModel, Regressor):
    ...
    .. ipython:: python
        ...
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lsvr_feature.html")
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lsvr_feature.html
    ...
    .. ipython:: python
        ...
        result = model.report()
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lsvr_report.html", "w")
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lsvr_report.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lsvr_report_anova.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lsvr_report_anova.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lsvr_prediction.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lsvr_prediction.html
    ...
    **To Python**
    ...
    @property
    def _sklearn_model(self) -> Literal[sklearn.svm.LinearSVR]:
...
class LinearSVC(LinearModelClassifier, BinaryClassifier):
    ...
    .. ipython:: python
        ...
        vo.set_option("plotting_lib", "plotly")
        fig = model.features_importance()
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_feature.html")
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_feature.html
    ...
    .. ipython:: python
        ...
        result = model.report()
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_report.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_report.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_report_cutoff.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_report_cutoff.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_prediction.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_prediction.html
    ...
    .. ipython:: python
        ...
        html_file = open("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_proba.html", "w")
        html_file.write(result._repr_html_())
        html_file.close()
    ...
    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_proba.html
    ...
    .. ipython:: python
        ...
        fig = model.roc_curve()
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_roc.html")

    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_linear_model_lscv_roc.html
    ...
    **To Python**
    ...
    @property
    def _sklearn_model(self) -> Literal[sklearn.svm.LinearSVC]:
    ...
    def plot(
        ...
        **style_kwargs
        ...
        return vo_plt.SVMClassifierPlot(
