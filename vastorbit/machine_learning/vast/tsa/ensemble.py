...
from vastorbit._typing import NoneType, PlottingObject, SQLColumns, SQLRelation
from vastorbit._utils._print import print_message
from vastorbit._utils._sql._collect import save_vastorbit_logs
from vastorbit._utils._sql._format import extract_subquery, quote_ident, schema_relation
...
from vastorbit.machine_learning.vast.tsa.arima import ARIMA
...
class TimeSeriesByCategory(TimeSeriesModelBase):
    ...
    _is_already_stored: bool
        This tells us whether a model is stored in the VAST
        database.
    ...
    .. ipython:: python
        ...
        from vastorbit.machine_learning.vast.tsa.ensemble import TimeSeriesByCategory
    ...
    .. ipython:: python
        ...
        fig.write_html("SPHINX_DIRECTORY/figures/machine_learning_VAST_tsa_ensemble_timeseriesbycategory_1.html")

    .. raw:: html
        :file: SPHINX_DIRECTORY/figures/machine_learning_VAST_tsa_ensemble_timeseriesbycategory_1.html
    ...
    def _fit_sql(self) -> str:
        return self.parameters["base_model"]._fit_sql

    @property
    def _predict_sql(self) -> str:
        return self.parameters["base_model"]._predict_sql
