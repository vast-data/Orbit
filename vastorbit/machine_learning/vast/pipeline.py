...
from vastorbit.machine_learning.vast.base import Regressor, VASTModel
...
class Pipeline:
    ...
    def __getitem__(self, index) -> VASTModel:
    ...
    def predict(
        ...
        vdf: SQLRelation, optional
            Input  VastFrame.  You  can  also  specify  a
        ...
        X: SQLColumns, optional
            List of the input VastColumns.
        name: str, optional
            Name of the added VastColumn.
