...
from vastorbit._typing import PlottingObject, PythonScalar, SQLColumns, SQLRelation
...
def validation_curve(
    ...
    **style_kwargs
    ...
    .. seealso::
        ...
        | :py:func:`~vastorbit.machine_learning.model_selection.learning_curve` :
...
def plot_acf_pacf(
    ...
    **style_kwargs
    ...
    using the ``VastFrame.``:py:meth:`~vastorbit.VastFrame.plot`:
    ...
    .. seealso::
        ...
        | :py:func:`~VastFrame.acf` : ACF plot from a :py:class:`~VastFrame`.
        | :py:func:`~VastFrame.pacf` : PACF plot from a :py:class:`~VastFrame`.
    """
    ...
    if show:
        ...
        return vo_plt.ACFPACFPlot(data=data, layout=layout).draw(**kwargs)
    return TableSample(
        {
            "index": index,
