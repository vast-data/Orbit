...
def grid_search_cv(
    ...
    **kwargs,
    ...
    .. seealso::
        ...
        | :py:func:`~vastorbit.machine_learning.model_selection.hp_tuning.cv.bayesian_search_cv` :
...
def bayesian_search_cv(
    ...
    **kwargs,
    ...
    .. code-block:: python
        ...
        from vastorbit.machine_learning.model_selection import bayesian_search_cv
    ...
    .. note::
        ...
        In vastorbit, Bayesian optimization
        ...
        vastorbit to efficiently navigate the
    ...
    **kwargs,
    ...
    estimator_type: str, optional
        ...
        - auto:
            detects if it is a
            :py:class:`~vastorbit.machine_learning.vast.linear_model.LogisticRegression`
            or :py:class:`~vastorbit.machine_learning.vast.linear_model.ElasticNet`.

        - logit:
            :py:class:`~vastorbit.machine_learning.vast.linear_model.LogisticRegression`

        - enet:
            :py:class:`~vastorbit.machine_learning.vast.linear_model.ElasticNet`
    ...
    Now we can conveniently use the
    :py:func:`~vastorbit.machine_learning.model_selection.hp_tuning.cv.enet_search_cv`
    ...
    .. code-block:: python
        ...
        from vastorbit.machine_learning.model_selection import enet_search_cv
    ...
    .. note::
        ...
        In vastorbit, Elastic Net Cross-Validation
