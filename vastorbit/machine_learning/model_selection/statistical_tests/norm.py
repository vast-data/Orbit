...
def jarque_bera(input_relation: SQLRelation, column: str) -> tuple[float, float]:
    ...
    Now we can create the :py:class:`~VastFrame`:

    .. ipython:: python

        vdf = vo.VastFrame({"col": data})
    ...
    And simply apply it on the :py:class:`~VastFrame`:
...
def kurtosistest(input_relation: SQLRelation, column: str) -> tuple[float, float]:
    ...
    .. ipython:: python
        ...
        from vastorbit.machine_learning.model_selection.statistical_tests import kurtosistest
...
def normaltest(input_relation: SQLRelation, column: str) -> tuple[float, float]:
    ...
    .. ipython:: python
        ...
        from vastorbit.machine_learning.model_selection.statistical_tests import normaltest
...
def skewtest(input_relation: SQLRelation, column: str) -> tuple[float, float]:
    ...
    .. ipython:: python
        ...
        from vastorbit.machine_learning.model_selection.statistical_tests import skewtest
