...
def het_breuschpagan(
    ...
    We can use those values to create the :py:class:`~VastFrame`:
...
def het_goldfeldquandt(
    ...
    .. ipython:: python
        ...
        from vastorbit.machine_learning.model_selection.statistical_tests import het_goldfeldquandt
