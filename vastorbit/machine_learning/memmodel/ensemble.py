...
from vastorbit._utils._sql._format import clean_query, format_type

from vastorbit.machine_learning.memmodel.base import InMemoryModel, MulticlassClassifier
...
class Ensemble(InMemoryModel):
    ...
    def plot_tree(
        ...
        **kwargs,
        ...
        create many ``BinaryTreeClassifier``.
...
class RandomForestRegressor(Ensemble):
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.RandomForestRegressor.predict`
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.RandomForestRegressor.predict_sql`
...
class RandomForestClassifier(Ensemble, MulticlassClassifier):
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.RandomForestClassifier.predict`
    method to do predictions.
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.RandomForestClassifier.predict_proba`
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.RandomForestClassifier.predict_sql`
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.RandomForestClassifier.predict_proba_sql`
    method to get the SQL code
    needed to deploy the model
    ...
    **Drawing Trees**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.RandomForestClassifier.plot_tree`
    method to draw the input tree.
...
class IsolationForest(Ensemble):
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.IsolationForest.predict`
    method to do predictions.
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.ensemble.IsolationForest.predict_sql`
    method to get the SQL code
    needed to deploy the model
    using its attributes.
