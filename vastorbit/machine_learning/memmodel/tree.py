...
from vastorbit.plotting.base import get_default_graphviz_options
...
class BinaryTreeRegressor(Tree):
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.BinaryTreeRegressor.predict`
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.BinaryTreeRegressor.predict_sql`
...
class BinaryTreeAnomaly(Tree):
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.BinaryTreeAnomaly.predict`
    method to do predictions.
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.BinaryTreeAnomaly.predict_sql`
    method to get the SQL code
    needed to deploy the model
    using its attributes.
...
class BinaryTreeClassifier(Tree):
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.BinaryTreeClassifier.predict`
    method to do predictions.
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.BinaryTreeClassifier.predict_proba`
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.BinaryTreeClassifier.predict_sql`
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.BinaryTreeClassifier.predict_proba_sql`
    method to get the SQL code
    needed to deploy the model
...
class NonBinaryTree(Tree):
    ...
    **Initalization**
    ...
    :py:class:`~vastorbit.machine_learning.memmodel.tree.NonBinaryTree`
    model.
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.NonBinaryTree.predict`
    method to do predictions.
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.NonBinaryTree.predict_proba`
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.NonBinaryTree.predict_sql`
    method to get the SQL code
    needed to deploy the model
    using its attributes.
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.tree.NonBinaryTree.predict_proba_sql`
    method to get the SQL code
    needed to deploy the model
    that computes predicted
    probabilities.
