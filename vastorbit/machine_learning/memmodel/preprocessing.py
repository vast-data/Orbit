...
class StandardScaler(Scaler):
    ...
    **Making In-Memory Transformation**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.preprocessing.StandardScaler.transform`
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.preprocessing.StandardScaler.transform_sql`
...
class MinMaxScaler(Scaler):
    ...
    **Making In-Memory Transformation**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.preprocessing.MinMaxScaler.transform`
    method to do transformation.
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.preprocessing.MinMaxScaler.transform_sql`
    method to get the SQL code
    needed to deploy the model
    using its attributes.
...
class OneHotEncoder(InMemoryModel):
    ...
    **Making In-Memory Transformation**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.preprocessing.OneHotEncoder.transform`
    method to do transformation.
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.preprocessing.OneHotEncoder.transform_sql`
    method to get the SQL code
    needed to deploy the model
    using its attributes.
