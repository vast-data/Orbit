...
class LinearModel(InMemoryModel):
    ...
    **Initalization**
    ...
    Let's create a :py:class:`~vastorbit.machine_learning.memmodel.linear_model.LinearModel`.
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.linear_model.LinearModel.predict`
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.linear_model.LinearModel.predict_sql`
    ...
    def _predict_logit_sql(self, X: ArrayLike) -> str:
        ...
        """
        return (
            f"1.000000000 / (1.000000000 + EXP(- ({self._predict_regression_sql(X)})))"
        )
    ...
    def predict_proba_sql(self, X: ArrayLike) -> list[str]:
        ...
        return [f"1.000000000 - ({probability_1})", probability_1]
...
class LinearModelClassifier(LinearModel):
    ...
    **Initalization**
    ...
    Let's create a :py:class:`~vastorbit.machine_learning.memmodel.linear_model.LinearModelClassifier`.
    ...
    **Making In-Memory Predictions**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.linear_model.LinearModelClassifier.predict`
    method to do predictions.
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.linear_model.LinearModel.predict_proba`
    ...
    **Deploy SQL Code**
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.linear_model.LinearModelClassifier.predict_sql`
    method to get the SQL code
    needed to deploy the model
    using its attributes.
    ...
    Use
    :py:meth:`~vastorbit.machine_learning.memmodel.linear_model.LinearModel.predict_proba_sql`
    method to get the SQL code
    needed to deploy the model
    ...
    def predict_sql(self, X: ArrayLike) -> str:
        ...
        .. note::
            ...
            different methods and usages.
        """
        return f"CAST((({self._predict_logit_sql(X)}) > 0.5) AS INT)"
