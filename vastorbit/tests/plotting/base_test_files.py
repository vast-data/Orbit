...
from vastorbit.machine_learning.vast.neighbors import LocalOutlierFactor
from vastorbit.machine_learning.vast.linear_model import LogisticRegression
from vastorbit.machine_learning.metrics import lift_chart, prc_curve
from vastorbit.machine_learning.vast.decomposition import PCA, MCA
...
class VDCPiePlot:
    ...
    def plot_result(self, dummy_vd):
        """
        Create a pie plot for VastColumn
        """
...
class NestedVDFPiePlot:
    ...
    def plot_result_2(self, dummy_vd):
        """
        Create a pie plot for VastFrame
        """
...
class VDCSpiderPlot:
    ...
    def plot_result(self, dummy_dist_vd):
        """
        Create a spider plot for VastColumn
        """
    ...
    def plot_result_2(self, dummy_dist_vd):
        """
        Create a spider plot for VastColumn using "by" parameter
        """
...
class StepwisePlot:
    ...
    def test_additional_options_custom_height(self, titanic_vd):
        ...
        custom_width = 70
        model = LogisticRegression(
            name="test_LR_titanic", tol=1e-4, max_iter=100, solver="lbfgs"
        )
        # Act
        stepwise_result = stepwise(
            model,
