...
from vastorbit.tests.machine_learning.metrics.test_classification_metrics import (
    python_metrics,
)
...
@pytest.fixture(name="get_vo_model", scope="function")
def get_vo_model_fixture(
    winequality_vo_fun, titanic_vd_fun, airline_vd_fun, iris_vd_fun, schema_loader
):
    """
    getter function for VAST tree model
    """

    def _get_vo_model(model_class, X=None, y=None, **kwargs):
        schema_name, model_name = schema_loader, f"vo_model_{model_class}"
...
def calculate_regression_metrics(get_py_model):
    ...
    def _calculate_regression_metrics(model_class, model_obj=None, fit_intercept=True):
        ...
        regression_metrics_map["r2"] = regression_metrics_map["r2_score"] = (
...
def calculate_classification_metrics(get_py_model):
    ...
    def _calculate_classification_metrics(model_class, model_obj=None):
        ...
        classification_metrics_map["f1_score"] = classification_metrics_map["f1"] = (
